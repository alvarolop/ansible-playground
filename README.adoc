...
[source, bash]
----
ansible-navigator run -m stdout plays/03-facts.yaml
----


== Ansible Loops, Conditionals, and Handlers


[source, bash]
----
ansible-navigator run -m stdout --ask-become-pass plays/04-task-control.yaml
----
...
[source, bash]
----
ansible-navigator run -m stdout plays/05-deploy-files.yaml
----